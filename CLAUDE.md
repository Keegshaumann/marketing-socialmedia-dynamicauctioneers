...
- **Next:** external-credential open questions (§10): platform hosting (the big one), Prop Data feed access, LinkedIn page-vs-profile decision; then Nikki running a property end to end as the real acceptance test.
