...
- **Next:** external-credential open questions (§10): Prop Data feed access, platform hosting, LinkedIn page-vs-profile decision; then live M3 web-research verification when tier limits allow.
