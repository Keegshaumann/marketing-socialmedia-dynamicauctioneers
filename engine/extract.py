...
SYSTEM_PROMPT = (
    ...
    "square metres and title deed number exactly as stated, a short title as the "
    "sources name it (for example \"Holding 10\" or \"Portion 6\"), and in features "
    "the improvements the sources attribute to THAT portion (\"Horse stables\", "
    "\"Double-storey 4-bed house\"). Leave a portion's features empty rather than "
    "guess which portion an improvement stands on. Do NOT add the "
...
SECTIONS: Tuple[Tuple[str, Type[_Base], str], ...] = (
    ...
    (
        ...
        "deed, a short title, and the improvements the sources place on that "
        "portion) and do not sum the extents yourself. When the sources disagree on ANY physical "
